...
source("./Data/Packages.R"); require(labelled); require(lme4)

lf_df <- readRDS( file = "./Data/lf_df.rds")
...
boot_fun_uk <- function( seed = 1, df1 = subuk, df2 = base_uk, id = "patient",
...
fev_formula_basic = "first_fev ~ age_1st_fev + 
                         intercept + 
                         slope"

fvc_formula_basic = "first_fvc ~ age_1st_fev + 
                         intercept + 
                         slope"


fev_formula_adj = "first_fev ~ age_1st_fev + 
                         intercept + 
...
fvc_formula_adj = "first_fvc ~ age_1st_fev + 
                         intercept + 
                         slope + sex + year_birth +
                         dmg_IMD_zscore + 
                         F508_class + pi + 
...
saveRDS(basic_mod_wt_fev, "./Objects/basic_mod_wt_fev.RDS")
...
#                                                                      df2 = lf_df) ))
# 
# saveRDS(booted_coefs_wt1, file = "./Objects/booted_coefs_uk_wt_1.RDS")

booted_coefs_wt1 <- readRDS( file = "./Objects/booted_coefs_uk_wt_1.RDS" )
...
write.csv(coefs_wt1, file = "./Objects/Model_results/uk_confints_wt_fev.csv")
...
write.csv(coefs_wt_fvc1, file = "./Objects/Model_results/uk_confints_wt_fvc.csv")
...
# Model
basic_mod_bmi_fev <- boot_fun_uk(seed = NA,
...
#                                                                     df2 = lf_df) )) #
# 
# saveRDS(booted_coefs_bmi, file = "./Objects/booted_coefs_uk_bmi_1.RDS")

booted_coefs_bmi1 <- readRDS( file = "./Objects/booted_coefs_uk_bmi_1.RDS" )
...
write.csv(coefs_bmi_fev1, file = "./Objects/Model_results/uk_confints_bmi_fev.csv")

### (ii) FVC%  

# Model
basic_mod_bmi_fvc <- boot_fun_uk(seed = NA,
                                wt_outcome = bmi_formula, 
                                lf_formula = fvc_formula_basic,
                                df1 = subuk,
                                df2 = lf_df, 
...
coefs_bmi_fvc1 <- data.frame( coef = coef_bmi_fvc1, lwr = confints_bmi1$boot_lwr, upr = confints_bmi1$boot_upr )
...
write.csv(coefs_bmi_fvc1, file = "./Objects/Model_results/uk_confints_bmi_fvc.csv")
...
#                                                                      df2 = lf_df) ))
# 
# saveRDS(booted_coefs_wt2, file = "./Objects/booted_coefs_uk_wt_2.RDS")

booted_coefs_wt2 <- readRDS( file = "./Objects/booted_coefs_uk_wt_2.RDS" )
...
write.csv(coefs_wt2, file = "./Objects/Model_results/uk_confints_wt_fev2.csv")
...
write.csv(coefs_wt_fvc2, file = "./Objects/Model_results/uk_confints_wt_fvc2.csv")
...
# Model
adj_mod_bmi_fev <- boot_fun_uk(seed = NA,
                                 wt_outcome = bmi_formula, 
                                 lf_formula = fev_formula_adj,
                                 df1 = subuk,
                                 df2 = lf_df, 
...
#                                                                     df2 = lf_df) )) #
# 
# saveRDS(booted_coefs_bmi2, file = "./Objects/booted_coefs_uk_bmi_2.RDS")

booted_coefs_bmi2 <- readRDS( file = "./Objects/booted_coefs_uk_bmi_2.RDS" )
...
write.csv(coefs_bmi_fev2, file = "./Objects/Model_results/uk_confints_bmi_fev2.csv")
...
# Model
adj_mod_bmi_fvc <- boot_fun_uk(seed = NA,
                                 wt_outcome = bmi_formula, 
                                 lf_formula = fvc_formula_adj,
                                 df1 = subuk,
                                 df2 = lf_df, 
...
write.csv(coefs_bmi_fvc2, file = "./Objects/Model_results/uk_confints_bmi_fvc2.csv")
...
lf_df_plus = merge(lf_df, weight_summaries, by = "patient_id")
lf_df_plus = merge(lf_df_plus, bmi_summaries, by = "patient_id")
...
lf_df_plus = merge(lf_df_plus, wt_lf_preds, by = "patient_id")
lf_df_plus = merge(lf_df_plus, bmi_lf_preds, by = "patient_id")


# save


saveRDS(lf_df_plus, file = "./Data/lf_df_plus.RDS")
...
df1 = data.frame( age_1st_fev = 6, slope = quantile(lf_df_plus$weight_slope, c(0.25, 0.75)), intercept = 0)

df1$pred = predict(basic_mod_wt_fev, newdata = df1, re.form = NA)
df1$pred[2] - df1$pred[1]        


df2 = data.frame( age_1st_fev = 6, intercept = quantile(lf_df_plus$weight_intercept, c(0.25, 0.75)), slope = 0)       

df2$pred = predict(basic_mod_wt_fev, newdata = df2, re.form = NA)
df2$pred[2] - df2$pred[1]  

saveRDS(df1, "./Objects/df1_for_scatter_uk.RDS")
saveRDS(df2, "./Objects/df2_for_scatter_uk.RDS")
